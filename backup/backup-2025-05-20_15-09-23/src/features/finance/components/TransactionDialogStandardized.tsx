 ...
 * {@link import('@/features/finance/components/TransactionDialogStandardized')}
 * 
...
import { TransactionDialogStandardized as FeatureTransactionDialogStandardized } from "@/features/finance/components/TransactionDialogStandardized";
 ...
 * {@link import('@/features/finance/components/TransactionDialogStandardized')}
 */
export default function TransactionDialogStandardized() {
  ...
  useEffect(() => {
    trackDeprecatedComponentUsage(
      ...
      "@/features/finance/components/TransactionDialogStandardized"
    );
  }, []);
  
  // Re-export the feature component
  return <FeatureTransactionDialogStandardized />;
}
