      ...
      <AnimatePresence>
        {toasts.map((toast) => (
          ...
          >
            ...
            <button
              type="button"
              className="ml-4 shrink-0 rounded-md p-1 hover:bg-black bg-opacity-10 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-transparent focus:ring-white"
              onClick={() => {
                dismiss(toast.id);
