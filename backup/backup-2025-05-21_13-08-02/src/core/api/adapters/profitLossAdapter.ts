 ...
 */
export function adaptApiProfitLossToSummary(apiProfitLoss: ApiProfitLoss): ProfitLossSummary {
  return {
    id: apiProfitLoss.id,
 ...
 */
export function adaptApiProfitLossToDetails(apiProfitLoss: ApiProfitLoss): ProfitLossDetails {
 ...
 */
export function adaptSummaryToApiProfitLoss(summary: ProfitLossSummary): Omit<ApiProfitLoss, 'id' | 'created_at' | 'updated_at'> {
  return {
 ...
 * (for use in create/update operations)
 */
export function adaptDetailsToApiProfitLoss(details: ProfitLossDetails): Omit<ApiProfitLoss, 'id' | 'created_at' | 'updated_at'> {
  return {
