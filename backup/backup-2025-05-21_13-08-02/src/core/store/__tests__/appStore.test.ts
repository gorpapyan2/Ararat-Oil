...
describe('appStore', () => {
  ...
  describe('theme management', () => {
    ...
    it('should handle system theme', () => {
      ...
      expect(document.documentElement.className).toBe(THEME_CONFIG.THEME_CLASSES.DARK);
      ...
      expect(document.documentElement.className).toBe(THEME_CONFIG.THEME_CLASSES.LIGHT);
    });
  });
