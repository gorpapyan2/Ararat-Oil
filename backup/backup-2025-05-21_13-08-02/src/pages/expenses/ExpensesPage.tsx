...
export function ExpensesPage() {
  ...
  const pageDescription = useMemo(() => t("expenses.description", "Track and manage all expenses across the station"), [t]);
      ...
      <div className="space-y-4">
        ...
        {(dateRange.from > new Date() || (dateRange.to && dateRange.to < new Date(Date.now() - 365 * 24 * 60 * 60 * 1000))) && (
          <Alert variant="default" className="bg-muted border-amber-500/50">
            ...
            <AlertDescription>
              {t("expenses.dateRangeWarning", "The selected date range may not contain any data. Consider adjusting your date filter.")}
            </AlertDescription>
          </Alert>
        )}
