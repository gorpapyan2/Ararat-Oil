  ...
  return (
    <div className={cn("space-y-5", className)}>
      <div className="flex justify-between items-center">
        ...
        {isCustomRange && (
          <Button
            ...
            className="h-6 px-2 text-xs text-[var(--color-muted-foreground)] hover:text-[var(--color-foreground)] transition-colors"
          >
      ...
      <div className="relative pt-5 pb-8">
        ...
        <div
          className={cn(
            "absolute top-0 px-2 py-1 rounded-md text-xs bg-[var(--color-primary)] text-[var(--color-primary-foreground)] transform -translate-x-1/2 transition-all duration-200",
        ...
        >
          {formatValue(value[0])}
          <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 rotate-45 w-2 h-2 bg-[var(--color-primary)]"></div>
        </div>
        ...
        {/* Value markers */}
        <div className="flex justify-between mt-1 px-1 text-xs text-[var(--color-muted-foreground)]">
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex flex-col flex-1">
          <span className="text-xs text-[var(--color-muted-foreground)] mb-1">
            Min
          </span>
          <Input
            type="text"
            ...
            className="h-8 bg-[var(--color-50)] bg-opacity-$2 border-[var(--color-50)] border-opacity-$2 hover:bg-[var(--color-80)] bg-opacity-$2 focus:border-[var(--color-50)] border-opacity-$2 focus:ring-1 focus:ring-[var(--color-primary)]/30 transition-colors"
          />
        </div>
        <div className="flex flex-col flex-1">
          <span className="text-xs text-[var(--color-muted-foreground)] mb-1">
