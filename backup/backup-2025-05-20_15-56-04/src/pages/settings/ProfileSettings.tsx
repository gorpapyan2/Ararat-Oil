...
function ProfileSettings() {
  ...
  const handleProfileUpdate = async (data: any) => {
    try {
      ...
      toast({
        title: "Success",
        description: getApiSuccessMessage(apiNamespaces.settings, 'update', 'profile'),
      });
      ...
      toast({
        title: "Error",
        description: getApiErrorMessage(apiNamespaces.settings, 'update', 'profile'),
        variant: "destructive",
      });
  ...
  const handleRemoveAvatar = () => {
    ...
    toast({
      title: "Success",
      description: getApiSuccessMessage(apiNamespaces.settings, 'update', 'avatar'),
    });
  };
