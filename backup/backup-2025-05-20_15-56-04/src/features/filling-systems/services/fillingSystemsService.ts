 ...
 */
export const getFillingSystemsWithFilters = async (filters?: FillingSystemFilters) => {
 ...
 */
export const createFillingSystem = async (fillingSystem: CreateFillingSystemRequest) => {
 ...
 */
export const updateFillingSystem = async (id: string, fillingSystem: UpdateFillingSystemRequest) => {
  // Adapt our feature's type to the API's expected type
  const updateData: {
    name?: string;
    location?: string;
