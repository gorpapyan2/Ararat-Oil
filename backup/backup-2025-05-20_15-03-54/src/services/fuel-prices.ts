/**
 * @deprecated Use the new feature-based implementation from '@/features/fuel-prices' instead.
 * This file is maintained for backward compatibility and will be removed in a future release.
 * 
 * Example:
 * // Old way (deprecated)
 * import { getFuelPrices } from '@/services/fuel-prices';
 * 
 * // New way
 * import { getFuelPrices } from '@/features/fuel-prices';
 */
