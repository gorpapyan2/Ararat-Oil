            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-6 md:grid-cols-3">
                <RangeSliderFilter
                  ...
                  onChange={([min, max]) =>
                    onFiltersChange({ minQuantity: min, maxQuantity: max })
                  }
                  formatValue={(val) => `${val}`}
                />
                <RangeSliderFilter
                ...
                <RangeSliderFilter
                  ...
                  onChange={([min, max]) =>
                    onFiltersChange({ minTotal: min, maxTotal: max })
                  }
    ...
    <div className="w-full md:hidden">
      <div className="flex items-center gap-2 mb-4">
        ...
        <Sheet>
          ...
          <SheetContent
            side="bottom"
            className="h-[85vh] sm:h-[75vh] sm:max-w-none rounded-t-xl"
          >
            ...
            <Tabs defaultValue="filters" className="mt-4">
              <TabsList className="w-full">
                ...
                <TabsTrigger value="ranges" className="flex-1">
                  Ranges
                </TabsTrigger>
              </TabsList>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <DateRangeFilter
                      ...
                      onDateChange={(val) =>
                        handleTempFilterChange({ date: val })
                      }
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <ProviderFilter
                      ...
                      onChange={(val) =>
                        handleTempFilterChange({ provider: val })
                      }
                      providers={providers}
                      isLoading={isLoading}
                    />
              ...
              <TabsContent value="ranges" className="mt-4">
                <div className="space-y-6">
                  ...
                  <RangeSliderFilter
                    ...
                    onChange={([min, max]) =>
                      handleTempFilterChange({ minPrice: min, maxPrice: max })
                    }
                    formatValue={(val) => `${val} ֏`}
                  />
                  ...
                  <RangeSliderFilter
                    ...
                    onChange={([min, max]) =>
                      handleTempFilterChange({ minTotal: min, maxTotal: max })
                    }
                    formatValue={(val) => `${val.toLocaleString()} ֏`}
                  />
                </div>
          ...
          {(filters.minQuantity > 0 || filters.maxQuantity < 10000) && (
            <Badge variant="secondary" className="flex items-center gap-1">
              ...
              <X
                className="h-3 w-3 ml-1 cursor-pointer"
                onClick={() =>
                  onFiltersChange({ minQuantity: 0, maxQuantity: 10000 })
                }
              />
            </Badge>
          )}
