      ...
      <div className="flex gap-2">
        <Popover open={isCalendarOpen} onOpenChange={setIsCalendarOpen}>
          ...
          >
            <Calendar
              ...
              className="p-3"
            />
            <div className="flex items-center justify-between p-3 border-t border-[var(--color-30)] border-opacity-$2 bg-[hsl(var(--30))] bg-opacity-$2">
              <Button
                variant="ghost"
                size="sm"
                onClick={clearDateRange}
                className="text-[var(--color-muted-foreground)] hover:text-[hsl(var(--foreground))] transition-colors"
              >
                {t("common.clear")}
              </Button>
              <Button
                ...
                className="bg-[var(--color-90)] bg-opacity-$2 hover:bg-[hsl(var(--primary))] transition-colors"
              >
                {t("common.apply")}
              </Button>
            </div>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="outline"
              className="px-2 bg-[var(--color-50)] bg-opacity-$2 border-[hsl(var(--50))] border-opacity-$2 hover:bg-[hsl(var(--80))] bg-opacity-$2 transition-colors"
            >
          ...
          >
            ...
            <DropdownMenuItem
              onClick={clearDateRange}
              className="text-[var(--color-muted-foreground)] hover:text-[hsl(var(--foreground))] hover:bg-[hsl(var(--10))] bg-opacity-$2 transition-colors"
            >
