      ...
      <div className="flex justify-between items-center">
        ...
        {isCustomRange && (
          <Button
            ...
            className="h-6 px-2 text-xs text-[var(--color-muted-foreground)] hover:text-[hsl(var(--foreground))] transition-colors"
          >
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex flex-col flex-1">
          ...
          <Input
            ...
            className="h-8 bg-[var(--color-50)] bg-opacity-$2 border-[hsl(var(--50))] border-opacity-$2 hover:bg-[hsl(var(--80))] bg-opacity-$2 focus:border-[hsl(var(--50))] border-opacity-$2 focus:ring-1 focus:ring-[hsl(var(--primary))]/30 transition-colors"
          />
        </div>
        <div className="flex flex-col flex-1">
          <span className="text-xs text-[var(--color-muted-foreground)] mb-1">
