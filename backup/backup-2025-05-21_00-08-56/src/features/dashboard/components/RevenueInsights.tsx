 ...
 * {@link import('@/features/dashboard/components/RevenueInsights')}
 * 
...
import { RevenueInsights as FeatureRevenueInsights } from "@/features/dashboard/components/RevenueInsights";
...
export default function RevenueInsights() {
  ...
  useEffect(() => {
    trackDeprecatedComponentUsage(
      ...
      "@/features/dashboard/components/RevenueInsights"
    );
  }, []);
  
  // Re-export the feature component
  return <FeatureRevenueInsights />;
}
