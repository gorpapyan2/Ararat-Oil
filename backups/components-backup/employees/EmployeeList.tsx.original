 ...
 * {@link import('@/features/employees/components/EmployeeList')}
 * 
...
import { EmployeeList as FeatureEmployeeList } from "@/features/employees/components/EmployeeList";
...
export default function EmployeeList() {
  ...
  useEffect(() => {
    trackDeprecatedComponentUsage(
      ...
      "@/features/employees/components/EmployeeList"
    );
  }, []);
  
  // Re-export the feature component
  return <FeatureEmployeeList />;
}
