 ...
 * {@link import('@/features/fuel-supplies/components/FuelSuppliesTable')}
 * 
...
import { FuelSuppliesTable as FeatureFuelSuppliesTable } from "@/features/fuel-supplies/components/FuelSuppliesTable";
 ...
 * {@link import('@/features/fuel-supplies/components/FuelSuppliesTable')}
 */
export default function FuelSuppliesTable() {
  // Issue a deprecation warning
  useEffect(() => {
    trackDeprecatedComponentUsage(
      "FuelSuppliesTable",
      "src\components\fuel-supplies\FuelSuppliesTable.tsx",
      "@/features/fuel-supplies/components/FuelSuppliesTable"
    );
  }, []);
  
  // Re-export the feature component
  return <FeatureFuelSuppliesTable />;
}
