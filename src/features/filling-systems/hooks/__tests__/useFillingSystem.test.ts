  ...
  describe("useFillingSystemMutations", () => {
    it("should create a filling system successfully", async () => {
      ...
      await waitFor(() => {
        ...
        expect(result.current.createFillingSystem.data).toEqual(
          createdFillingSystem
        );
      });
    ...
    it("should update a filling system successfully", async () => {
      ...
      await act(async () => {
        result.current.updateFillingSystem.mutate({
          id: fillingSystemId,
          data: updateData,
        });
      });
      ...
      await waitFor(() => {
        ...
        expect(result.current.updateFillingSystem.data).toEqual(
          updatedFillingSystem
        );
      });

      expect(updateFillingSystem).toHaveBeenCalledWith(
        fillingSystemId,
        updateData
      );
    });
