...
export function FinancialDashboardStandardized({
  className,
}: FinancialDashboardStandardizedProps) {
    ...
    <div className={className}>
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-2xl font-bold">
          {t("finance.financial_dashboard")}
        </h2>
        <div className="flex items-center space-x-2">
          <Select value={period} onValueChange={(val: string) => setPeriod(val as "7d" | "30d" | "90d")}>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="mb-4">
          ...
          <TabsTrigger value="revenue_expenses">
            {t("finance.revenue_and_expenses")}
          </TabsTrigger>
        </TabsList>
