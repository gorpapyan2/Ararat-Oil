...
import { AlertDialog, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter, AlertDialogHeader, AlertDialogTitle } from '@/core/components/ui/primitives/alert-dialog';
 ...
 */
export function SalesManager({ onSaleCreated, onSaleUpdated, onSaleDeleted }: SalesManagerProps) {
  ...
  const handleSubmit = useCallback(async (data: CreateSaleRequest) => {
    try {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex justify-between items-center">
        ...
        <Button 
          onClick={salesDialog.openCreateDialog}
          className="mb-4"
        >
