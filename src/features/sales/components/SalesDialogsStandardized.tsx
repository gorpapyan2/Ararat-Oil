...
import { z } from "zod";
import { FormField, FormItem, FormLabel, FormControl, FormMessage } from "@/core/components/ui/primitives/form";
  ...
  return (
    <>
      <FormDialog
        ...
        title={t("sales.edit", "Edit Sale")}
        description={t("sales.editDescription", "Update the details of this sale.")}
