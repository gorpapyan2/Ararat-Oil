 ...
 * {@link import('@/features/fuel-supplies/components/FuelSuppliesHeader')}
 * 
...
import { FuelSuppliesHeader as FeatureFuelSuppliesHeader } from "@/features/fuel-supplies/components/FuelSuppliesHeader";
 ...
 * {@link import('@/features/fuel-supplies/components/FuelSuppliesHeader')}
 */
export default function FuelSuppliesHeader() {
  // Issue a deprecation warning
  useEffect(() => {
    trackDeprecatedComponentUsage(
      "FuelSuppliesHeader",
      "src\components\fuel-supplies\FuelSuppliesHeader.tsx",
      "@/features/fuel-supplies/components/FuelSuppliesHeader"
    );
  }, []);
  
  // Re-export the feature component
  return <FeatureFuelSuppliesHeader />;
}
