...
describe('Tanks Hooks', () => {
  ...
  describe('useTanks', () => {
    it('should fetch tanks successfully', async () => {
      const mockTanks = [
        { id: '1', name: 'Tank 1', fuel_type_id: 'ft1', capacity: 1000, current_level: 700, is_active: true, created_at: '2023-01-01', updated_at: '2023-01-01' },
  ...
  describe('useTankLevelChanges', () => {
    it('should fetch tank level changes successfully', async () => {
      const mockLevelChanges = [
        { id: '1', tank_id: '1', previous_level: 600, new_level: 700, change_amount: 100, change_type: 'add', reason: 'Refill', created_at: '2023-01-01', created_by: 'user1' },
  ...
  describe('useTankMutations', () => {
    ...
    it('should adjust tank level successfully', async () => {
      ...
      expect(adjustTankLevel).toHaveBeenCalledWith(
        adjustmentData.tankId, 
        {
