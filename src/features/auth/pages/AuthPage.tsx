...
import { Eye, EyeOff, Fuel, Lock, Mail, User, Shield } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 flex items-center justify-center p-4">
      ...
      >
        ...
        {/* Footer */}
        <motion.div variants={itemVariants} className="text-center mt-8 text-sm text-gray-600">
          <p>© 2024 Fuel Station Manager. All rights reserved.</p>
