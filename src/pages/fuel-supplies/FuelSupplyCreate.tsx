...
export default function FuelSupplyCreate() {
  ...
  const [pendingData, setPendingData] =
    useState<CreateFuelSupplyRequest | null>(null);
    ...
    if (pendingData && activeShift?.id) {
      createSupply.mutate(pendingData, {
        ...
        onError: (error: unknown) => {
          ...
          toast({
            title: t("common.error"),
            description: error instanceof Error ? error.message : t("fuelSupplies.createError"),
            variant: "destructive",
          });
        ...
        <Alert variant="destructive">
          ...
          <AlertDescription>
            {createSupply.error instanceof Error
              ...
              : t(
                  "fuelSupplies.createError",
                  "Failed to create fuel supply record"
                )}
          </AlertDescription>
        </Alert>
      )}
