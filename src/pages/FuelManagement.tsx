...
export default function FuelManagement() {
  ...
  const [fillingSystemsAction, setFillingSystemsAction] = useState<React.ReactNode>(null);
  const [tanksAction, setTanksAction] = useState<React.ReactNode>(null);
  const [fuelSuppliesAction, setFuelSuppliesAction] = useState<React.ReactNode>(null);
