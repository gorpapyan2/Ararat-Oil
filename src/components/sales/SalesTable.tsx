...
import { Edit, MoreHorizontal, Trash2, Eye, Calendar, Fuel, Droplet, Banknote } from "lucide-react";
...
export function SalesTable({ 
  ...
  const columns = useMemo<ColumnDef<Sale>[]>(() => [
    ...
    },
    {
      ...
      header: () => <div className="text-left font-medium">Filling System</div>,
    ...
    {
      id: "quantity",
      header: () => <div className="text-right font-medium">Total Liters</div>,
