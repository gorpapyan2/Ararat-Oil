...
import { SidebarShortcuts } from '@/components/ui/sidebar-shortcuts';
          ...
          <Tooltip>
            ...
            <TooltipContent side="right">
              ...
              <div className="text-xs mt-1 opacity-80">
                <kbd className="inline-flex h-4 select-none items-center gap-1 rounded border bg-background px-1 font-mono text-[10px] font-medium">
                  Alt + S
                </kbd>
              </div>
            </TooltipContent>
