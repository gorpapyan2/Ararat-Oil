...
const CardHeader = React.forwardRef<HTMLDivElement, CardHeaderProps>(
  ({ className, padded = true, bordered = false, children, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
...
const CardTitle = React.forwardRef<HTMLHeadingElement, CardTitleProps>(
  (
    { className, size = "default", as: Comp = "h3", children, ...props },
    ref
  ) => {
    const sizeClasses = {
...
const CardMedia = React.forwardRef<HTMLDivElement, CardMediaProps>(
  (
    { className, position = "top", aspectRatio = "16:9", children, ...props },
    ref
  ) => {
...
const CardActions = React.forwardRef<HTMLDivElement, CardActionsProps>(
  ({ className, padded = true, align = "right", children, ...props }, ref) => {
    const alignClasses = {
      left: "justify-start",
      center: "justify-center",
      right: "justify-end",
