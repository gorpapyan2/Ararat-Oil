...
import type { FillingSystem, FillingSystemCreate, FillingSystemUpdate } from '../types';
 ...
 */
export async function getFilingSystems(): Promise<ApiResponse<FillingSystem[]>> {
 ...
 */
export async function validateTankIds(tankIds: string[]): Promise<ApiResponse<{ valid: boolean, invalidIds?: string[] }>> {
  return fetchFromFunction<{ valid: boolean, invalidIds?: string[] }>('filling-systems/validate-tank-ids', { 
