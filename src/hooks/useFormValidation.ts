 ...
 */
interface UseFormValidationOptions<TSchema extends z.ZodSchema> extends Omit<UseFormProps<z.infer<TSchema>>, 'resolver'> {
  /**
...
export function useFormValidation<TSchema extends z.ZodSchema>({
  ...
  return {
    ...
    setFormError: formHandler.setFormError,
    clearError: formHandler.clearError,
