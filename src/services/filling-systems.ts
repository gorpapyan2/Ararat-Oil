...
export const fetchFillingSystemById = async (
  id: string
  ...
  try {
    ...
    if (response.error) {
      console.error(
        `Error fetching filling system with ID ${id}:`,
        response.error
      );
      throw new Error(response.error.message);
    }
...
export const updateFillingSystem = async (
  ...
  try {
    ...
    if (response.error) {
      console.error(
        `Error updating filling system with ID ${id}:`,
        response.error
      );
      throw new Error(response.error.message);
    }
...
export const deleteFillingSystem = async (id: string): Promise<void> => {
  try {
    ...
    if (response.error) {
      console.error(
        `Error deleting filling system with ID ${id}:`,
        response.error
      );
      throw new Error(response.error.message);
    }
